...
#Lab04: Question 8
#Using the belt
print("You see a Monster in a distance, use the first item from your belt")
first_item = belt.pop(0)
if first_item in good_loot_options:
    health_points = min(6, (health_points + 2))
    print(f"You used the {first_item} item, your health has changed to {health_points}")
elif first_item in bad_loot_options:
    health_points = max(0, (health_points - 2))
    print(f"You found the {first_item} item, your health has changed to {health_points}")
else:
...
#Lab 04: Question 3
#Increase Monster's Combat Strength by its Power
m_combat_strength = min(6, (m_combat_strength + monster_power[power_roll] ))
print("The Monster Combat Strength is no " + str(m_combat_strength) + " using " + str(power_roll) + " magic power.")
